 ...
 * @param allSocketFunctions The function to get all servers' sockets
 * @param currentSocketFunctions The function to get the current server's socket
 */
const loadHostProxyEvent = function(io, allSocketFunctions, currentSocketFunctions) {
